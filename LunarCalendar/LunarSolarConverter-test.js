...
let solar = new Solar();
solar.solarYear = parseInt(year,10);
solar.solarMonth = parseInt(month,10);
solar.solarDay = parseInt(day,10);
let lunar = converter.SolarToLunar(solar);
console.log(lunar.lunarDay);



const sendMsg = encodeURI("今天大概是初"+lunar.lunarDay+"吧?");
